...
"""
This script presents the second analysis step: timescaleAnalysis
The preprocessed data is loaded, adjusted and the multi-exponential
fit is performed and plotted.
At the end of this step, the timescale spectra are saved
in such a way that it can be used for future plotting,
such as the dynamical content.
"""
...
@click.option(
    ...
    required=True,
    type=click.Path(),
    help='Path to json file with mean/sem/times/labels',
)
@click.option(
    '--number-decades',
    '-nD',
